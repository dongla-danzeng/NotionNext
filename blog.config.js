...
const BLOG = {
  ...
  NOTION_PAGE_ID: process.env.NOTION_PAGE_ID || '86306fca00754dcf819650dfad344351',
  ...
  AUTHOR: 'DANboy-ངག་བསྟན་', // 您的昵称 例如 tangly1024
  BIO: '一个普通de体制内员工的随笔录站🍚', // 作者简介
  LINK: 'https://danboy-1518.top', // 网站地址
  KEYWORDS: '软件分享, 硬件分享, 软件无线电, Java , Python,读书分享', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: 'danboywy@163.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: 'https://weibo.com/u/7009382219', // 你的微博个人主页
  //CONTACT_TWITTER: '', // 你的twitter个人主页
  CONTACT_GITHUB: 'https://github.com/dongla-danzeng', // 你的github个人主页 例如 https://github.com/tangly1024
  ...
  MUSIC_PLAYER_METING_ID: process.env.NEXT_PUBLIC_MUSIC_PLAYER_METING_ID || '494673505', // 对应歌单的 id
  ...
  // twikoo
  COMMENT_TWIKOO_ENV_ID: process.env.NEXT_PUBLIC_COMMENT_ENV_ID || 'https://danboy-twikoo.zeabur.app/', // TWIKOO地址 腾讯云环境填 envId；Vercel 环境域名地址（https://xxx.vercel.app)

  // utterance
  //COMMENT_UTTERRANCES_REPO: process.env.NEXT_PUBLIC_COMMENT_UTTERRANCES_REPO || 'https://github.com/dongla-danzeng', // 你的代码仓库名， 例如我是 'tangly1024/NotionNext'； 更多文档参考 https://utteranc.es/

  // giscus @see https://giscus.app/
//   COMMENT_GISCUS_REPO: process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO || 'https://github.com/dongla-danzeng', // 你的Github仓库名 e.g 'tangly1024/NotionNext'
...
//   COMMENT_DAO_VOICE_ID: process.env.NEXT_PUBLIC_COMMENT_DAO_VOICE_ID || '6746c37d', // DaoVoice http://dashboard.daovoice.io/get-started
...
//   COMMENT_VALINE_PLACEHOLDER: process.env.NEXT_PUBLIC_VALINE_PLACEHOLDER || '抢个沙发吧~', // 可以搭配后台管理评论 https://github.com/DesertsP/Valine-Admin  便于查看评论，以及邮件通知，垃圾评论过滤等功能
  ...
  COMMENT_WALINE_SERVER_URL: process.env.NEXT_PUBLIC_WALINE_SERVER_URL || 'https://my-waline-dnl6-fymx9vo4x-danboywy-163com.vercel.app/', // 请配置完整的Waline评论地址 例如 hhttps://preview-waline.tangly1024.com @see https://waline.js.org/guide/get-started.html
  ...
  ANALYTICS_CNZZ_ID: process.env.NEXT_PUBLIC_ANALYTICS_CNZZ_ID || 'LA_COLLECT', // 只需要填写站长统计的id, [cnzz_id] -> https://s9.cnzz.com/z_stat.php?id=[cnzz_id]&web_id=[cnzz_id]
